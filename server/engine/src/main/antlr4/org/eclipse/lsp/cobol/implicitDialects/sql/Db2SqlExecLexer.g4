...
HIGH : DOUBLEQUOTE H I G H DOUBLEQUOTE;
HINT: H I N T;
...
LOCKPART: L O C K P A R T;
LOGGED : L O G G E D;
LOW : DOUBLEQUOTE L O W DOUBLEQUOTE;
LOWER :L O W E R;
MAIN : M A I N;
...
NUMERICLITERAL : (PLUSCHAR | MINUSCHAR)?
    (
        ...
        DIGIT+
        (
            DOT_FS DIGIT* (('e' | 'E') (PLUSCHAR | MINUSCHAR)? DIGIT+)?
            |
            COMMACHAR { commaCharAllowed }?
            (
                DIGIT+ (('e' | 'E') (PLUSCHAR | MINUSCHAR)? DIGIT+)?
                |
...
CHAR_STRING_LITERAL_SINGLE_QUOTE: SINGLE_QUOTED_STRINGLITERAL;
CHAR_STRING_LITERAL_DOUBLE_QUOTE: DOUBLE_QUOTED_STRINGLITERAL;
HEXSTRING: HEXNUMBER;
BXSTRING: BXNUMBER;
