...
import static org.eclipse.lsp.cobol.core.engine.errors.ErrorFinalizerService.NON_FATAL_ERRORS;
      ...
      return toAnalysisResult(
          new ResultWithErrors<>(
              ...
              ctx.getAccumulatedErrors().stream()
                  .filter(err -> ErrorFinalizerService.filterDiagnotics(err, NON_FATAL_ERRORS))
