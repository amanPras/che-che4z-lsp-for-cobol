...
@AllArgsConstructor
public class Db2ProcedureDivisionProcessor implements Processor<Db2ProcedureDivisionNode> {
  final MessageService messageService;

  @Override
  public void accept(Db2ProcedureDivisionNode node, ProcessingContext processingContext) {
  ...
  private void throwError(Db2ProcedureDivisionNode node, ProcessingContext processingContext) {
    processingContext
        .getErrors()
        .add(
            SyntaxError.syntaxError()
                ...
                .messageTemplate(MessageTemplate.of("db2Parser.validation.procedureDiv"))
                .build());
  }
}
