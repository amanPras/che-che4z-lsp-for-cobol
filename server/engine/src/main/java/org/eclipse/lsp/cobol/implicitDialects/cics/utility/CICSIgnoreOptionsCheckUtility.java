...
/** Checks CICS IGNORE CONDITION rules for required and invalid options */
public class CICSIgnoreOptionsCheckUtility extends CICSOptionsCheckBaseUtility {
    public static final int RULE_INDEX = RULE_cics_ignore;
    ...
    public CICSIgnoreOptionsCheckUtility(DialectProcessingContext context, List<SyntaxError> errors) {
    ...
    public <E extends ParserRuleContext> void checkOptions(E ctx) {
        if (ctx instanceof CICSParser.Cics_ignore_optionsContext) {
            checkIgnoreCondition((CICSParser.Cics_ignore_optionsContext) ctx);
        }
        checkDuplicates(ctx);
    }
