...
/** Validate Db2DeclareVariableNode position */
@AllArgsConstructor
public class Db2DeclareVariableProcessor implements Processor<Db2DeclareVariableNode> {
  final MessageService messageService;

  @Override
  public void accept(Db2DeclareVariableNode node, ProcessingContext processingContext) {
  ...
  private void throwError(Db2DeclareVariableNode node, ProcessingContext processingContext) {
    processingContext
        .getErrors()
        .add(
            SyntaxError.syntaxError()
                ...
                .messageTemplate(MessageTemplate.of("db2Parser.validation.declareVar"))
                .build());
  }
}
